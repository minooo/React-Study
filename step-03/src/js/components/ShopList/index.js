...
const ShopList = ({data}) => {
  return (
    <div className={styles.listBox}>
      <Link to={{pathname:'/shop/' + data.id}} className={`cf ${styles.root}`}>
